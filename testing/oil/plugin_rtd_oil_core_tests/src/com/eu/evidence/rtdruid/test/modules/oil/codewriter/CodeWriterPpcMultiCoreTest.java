...
//	    "	OS EE { KERNEL_TYPE = FP; };	\n" +
	...
	@Test public void testDoublez4_SPC574K_timer_stm_handler() {
	    final String text = "CPU test_application {\n"+
			"\n"+
			"	OS EE {\n"+
			"		EE_OPT = \"__ASSERT__\";\n"+
	...
	@Test public void testDoublez4_SPC574K_systimer_stm_master() {
	    final String text = "CPU test_application {\n"+
			"\n"+
			"	OS EE {\n"+
			"		EE_OPT = \"__ASSERT__\";\n"+
	...
	@Test public void testDoublez4_SPC574K_systimer_stm_slave() {
	    final String text = "CPU test_application {\n"+
			"\n"+
			"	OS EE {\n"+
			"		EE_OPT = \"__ASSERT__\";\n"+
	...
	@Test public void testEE_MM_OPT() {
	    final String text = "CPU test_application {\n"+
			"\n"+
			"	OS EE {\n"+
			"		EE_OPT = \"__ASSERT__\";\n"+
